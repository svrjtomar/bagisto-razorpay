<x-admin::layouts>
  ...
  @if ($order->payment && $order->payment->method === 'razorpay')
    <div class="mt-4 p-4 border rounded bg-gray-50">
        <h4 class="font-semibold mb-2">Razorpay Payment Details</h4>

        <p>
            <strong>Razorpay Order ID:</strong>
            {{ data_get($order->payment->additional, 'razorpay_order_id', 'N/A') }}
        </p>

        <p>
            <strong>Razorpay Payment ID:</strong>
            {{ data_get($order->payment->additional, 'razorpay_payment_id', 'N/A') }}
        </p>
    </div>
@endif
